...
Two servo motors are controlled using PWM signals generated by the microcontroller. The SG92R positional servo is responsible for driving the flapping motion of the butterfly wings, while the SG90-HV continuous rotation servo provides rotational movement to represent accumulated interaction. Both servos share timing resources on the microcontroller, requiring coordinated control to ensure smooth operation.
